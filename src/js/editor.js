...
MD.Editor = function () {
  ...
  function clear() {
    ...
    $.confirm(`<h4 data-i18n="editor.clear_drawing_alert">Do you want to clear the drawing?</h4><p>This will also erase your undo history</p>`, function (ok) {
      if (!ok) return;
  ...
  function horizontal_rect() {
    const textarea = editor.modal.horizontal_rect.el.querySelector("textarea");
    textarea.value = 5
